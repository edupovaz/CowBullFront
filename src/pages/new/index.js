...
const New = () => {
    ...
    function submitHandler (e) {
        e.preventDefault();
        console.log(state);
        axios.post(`http://localhost:5000/api/gado/`, state)
          .then(response => {
            if(response.data != null) {
              console.log("Gado Inserido");
            }
          })
          .catch(error => {
            console.log(error)
    ...
    return(
        <div class="container-center-horizontal">
          ...
          <div class="overlap-group2">
                ...
                <button class="rectangle-21 inserir montserrat-normal-black-24px" type="submit" onClick={submitHandler}>Adicionar</button>
                </div>
        </div>
          </div>
        </div>
